...
public class HealthController {
    ...
    //         // 计算宠物年龄，处理birthday为null的情况
    //         int petAge = 0;
    //         if (p.getBirthday() != null) {
    //             String birthDate = MyUtils.getDate2String(p.getBirthday(), "yyyy-MM-dd");
    //             if (!birthDate.isEmpty()) {
    //                 petAge = MyUtils.get2DateDay(birthDate, MyUtils.getDate2String(new Date(), "yyyy-MM-dd"));
