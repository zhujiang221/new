...
const pinyinMap: Record<string, string> = {
  ...
  '还': 'H', '海': 'H', '含': 'H', '汉': 'H', '行': 'H', '好': 'H', '号': 'H', '和': 'H', '合': 'H', '河': 'H', '黑': 'H', '很': 'H', '红': 'H', '后': 'H', '候': 'H', '呼': 'H', '护': 'H', '花': 'H', '化': 'H', '话': 'H', '画': 'H', '划': 'H', '华': 'H', '怀': 'H', '坏': 'H', '欢': 'H', '环': 'H', '换': 'H', '黄': 'H', '回': 'H', '会': 'H', '活': 'H', '火': 'H',
  ...
  '再': 'Z', '在': 'Z', '咱': 'Z', '早': 'Z', '造': 'Z', '则': 'Z', '责': 'Z', '怎': 'Z', '增': 'Z', '展': 'Z', '占': 'Z', '战': 'Z', '站': 'Z', '张': 'Z', '章': 'Z', '长': 'Z', '掌': 'Z', '找': 'Z', '照': 'Z', '这': 'Z', '真': 'Z', '正': 'Z', '证': 'Z', '政': 'Z', '之': 'Z', '支': 'Z', '知': 'Z', '直': 'Z', '值': 'Z', '职': 'Z', '只': 'Z', '指': 'Z', '至': 'Z', '制': 'Z', '治': 'Z', '中': 'Z', '终': 'Z', '钟': 'Z', '种': 'Z', '重': 'Z', '周': 'Z', '主': 'Z', '住': 'Z', '助': 'Z', '注': 'Z', '祝': 'Z', '专': 'Z', '转': 'Z', '装': 'Z', '状': 'Z', '追': 'Z', '准': 'Z', '着': 'Z', '子': 'Z', '自': 'Z', '字': 'Z', '总': 'Z', '走': 'Z', '足': 'Z', '组': 'Z', '最': 'Z', '作': 'Z', '做': 'Z'
};
